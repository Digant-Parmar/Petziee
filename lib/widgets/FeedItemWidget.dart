...
class FeedItemWidget extends StatefulWidget {
  ...
  factory FeedItemWidget.fromDocument(DocumentSnapshot documentSnapshot){
  ...
  getUserProfile()async{
    ...
    if(docSnap.exists){
      setState(() {
        ...
        print("Owner details${owner.humanUrl}steps");
      });
    }
          ...
          decoration:BoxDecoration(
            boxShadow: [
              ...
              image: DecorationImage(
                image: thumbUrl!=""?NetworkImage(thumbUrl):Image.asset("assets/pets/dog.png"),
                fit: BoxFit.cover,
              ),
